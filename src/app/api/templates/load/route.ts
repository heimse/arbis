...
export async function POST(request: NextRequest) {
  try {
    ...
    const planFiles = [
      { file: 'plan-1-bedroom.json', title: 'Однокомнатная квартира', type: 'apartment', area: 24 },
      { file: 'plan-2-bedroom.json', title: 'Двухкомнатная квартира', type: 'apartment', area: 40 },
      { file: 'plan-3-bedroom.json', title: 'Трехкомнатная квартира', type: 'apartment', area: 60 },
      { file: 'plan-studio.json', title: 'Студия', type: 'apartment', area: 20 },
      { file: 'plan-with-balcony.json', title: 'Квартира с балконом', type: 'apartment', area: 35 },
      { file: 'plan-kitchen-living.json', title: 'Квартира с кухней', type: 'apartment', area: 50 },
    ]
